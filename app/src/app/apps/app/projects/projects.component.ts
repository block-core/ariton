...
import { Community, TableDataSource } from './projects-datasource';
  ...
  constructor(private router: Router) {
    ...
    for (let i = 0; i < this.images.length; i++) {
      cards.push({
        id: 'id' + 1,
        name: `Project ${i + 1}`,
        description: `This is a description of project. We are a great project created from a good community.`,
    ...
    cards.push({
      id: 'id' + 1,
      name: `New Knitting Patterns`,
      description: `Join the craft knitting project to create new amazing patterns.`,

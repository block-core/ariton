...
describe('MessageProtocol', () => {
  ...
  it('should create message protocol and perform actions', async () => {
    ...
    // Now that protocols is installed, assign writer between users.
    const { status: adminCreateStatus, record: writerRecord } = await dwnAlice.records.create({
